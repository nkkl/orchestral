...
class MusiciansControllerTest < ActionController::TestCase
  ...
  test "should create musician" do
    assert_difference('Musician.count') do
      post :create, musician: { instrument: @musician.instrument, sponsor: @musician.sponsor, status: @musician.status }
    end
  ...
  test "should update musician" do
    patch :update, id: @musician, musician: { instrument: @musician.instrument, sponsor: @musician.sponsor, status: @musician.status }
    assert_redirected_to musician_path(assigns(:musician))
  end
